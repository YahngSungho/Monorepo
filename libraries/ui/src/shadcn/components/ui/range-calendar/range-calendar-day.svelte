...
<RangeCalendarPrimitive.Day
	class={cn(
		...
		dark:data-[selection-start]:hover:bg-primary dark:data-[selection-start]:focus:bg-primary`,
		// Selection End
		...
		dark:data-[selection-end]:hover:bg-primary dark:data-[selection-end]:focus:bg-primary`,
		// Outside months
