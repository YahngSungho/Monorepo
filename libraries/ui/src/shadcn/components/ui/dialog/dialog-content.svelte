...
<Dialog.Portal {...portalProps}>
	...
	<DialogPrimitive.Content
		class={cn(
			...
			translate-x-[-50%] translate-y-[-50%] gap-4 border p-6 shadow-lg duration-200 sm:max-w-lg`,
			className,
		)}
	...
	>
		...
		<DialogPrimitive.Close
			class="ring-offset-background focus:ring-ring focus:outline-hidden absolute right-4 top-4
