...
_ Keys are consecutive integers starting from 1, corresponding to the input message numbers.
_Values are the translated strings (maintaining original Markdown) in the target language.
_ @typedef {{ [key: number]: string }} TranslatedMessages
\*/
