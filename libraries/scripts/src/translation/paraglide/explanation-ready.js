...
const missingExplanationsPath = getAbsolutePath(
	import.meta.url,
	'../../../../paraglide/messages-helpers/missing-explanations.json',
)
const explanationPath = getAbsolutePath(
	import.meta.url,
	'../../../../paraglide/messages-helpers/explanations.json',
)
