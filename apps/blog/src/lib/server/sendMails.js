...
export const sendMails_immediate_action = sendMails_base({ deliverytimeOptimizePeriod: false }, {
	name: 'Sungho Yahng',
	url: 'sungho.blog',
...
/** @type {SendMailsAction} */
export const sendMails_optimize_action = sendMails_base({ deliverytimeOptimizePeriod: true }, {
	name: 'Sungho Yahng',
	url: 'sungho.blog',
	myEmail: 'hi@sungho.blog',
	preprocessMarkdownText: ((string) => (string.replaceAll('(/posts/', '(https://sungho.blog/posts/')))
