...
declare module '$env/static/private' {
	...
	export const FILE_MARKER_DIR: string;
	...
	export const npm_package_dependencies__library_paraglide: string;
	...
	export const npm_package_scripts_buildWithDotenv: string;
	...
	export const npm_package_scripts_previewWithDotenv: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__library_paraglide: string;
		...
		npm_package_scripts_buildWithDotenv: string;
		...
		npm_package_scripts_previewWithDotenv: string;
